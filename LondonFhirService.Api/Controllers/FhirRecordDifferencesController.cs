    ...
    public class FhirRecordDifferencesController : RESTFulController
    {
            ...
            Guid fhirRecordDifferenceId)
        {
            try
            {
                ...
                when (fhirRecordDifferenceValidationException.InnerException
                    is NotFoundFhirRecordDifferenceException)
            {
            ...
            Guid fhirRecordDifferenceId)
        {
            try
            {
                FhirRecordDifference deletedFhirRecordDifference =
                    await this.fhirRecordDifferenceService
                        .RemoveFhirRecordDifferenceByIdAsync(fhirRecordDifferenceId);
