...
{
    internal partial class ObservationMatcherService : ResourceMatcherServiceBase, IResourceMatcherService
    {
        public ObservationMatcherService(ILoggingBroker loggingBroker)
            : base(loggingBroker)
        { }
