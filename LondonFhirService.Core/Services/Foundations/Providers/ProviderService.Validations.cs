    ...
    public partial class ProviderService
    {
        private async ValueTask ValidateProviderOnAdd(Provider provider)
        {
            ...
            Validate(
                ...
                (Rule: IsInvalid(provider.FriendlyName), Parameter: nameof(Provider.FriendlyName)),
                (Rule: IsInvalid(provider.FullyQualifiedName), Parameter: nameof(Provider.FullyQualifiedName)),
                ...
                (Rule: IsGreaterThan(provider.FullyQualifiedName, 500), Parameter: nameof(Provider.FullyQualifiedName)),
