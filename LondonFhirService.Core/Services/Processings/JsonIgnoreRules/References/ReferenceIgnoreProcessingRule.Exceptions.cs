...
{
    internal partial class ReferenceIgnoreProcessingRule
    {
            ...
            catch (Exception exception)
            {
                var failedJsonIgnoreRulesProcessingException =
                    new FailedJsonIgnoreRulesProcessingException(
                        message:
                            "Failed reference ignore processing exception occurred, please contact support",
            ...
            Xeption exception)
        {
            var jsonIgnoreRulesProcessingValidationException =
                new JsonIgnoreRulesProcessingValidationException(
                    message: "Reference ignore processing validation error occurred, please fix errors and try again.",
                    innerException: exception);
