...
namespace LondonFhirService.Api.Tests.Acceptance.Apis.Patients
{
    ...
    public partial class PatientTests
    {
        ...
        private async Task<Provider> CreateRandomActiveProvider(string providerName, DateTimeOffset dateTimeOffset)
        {
            Provider randomProvider = CreateActiveProviderFiller(providerName, dateTimeOffset).Create();
            Provider createdProvider = await SeedProviderAsync(randomProvider);

            return createdProvider;
        }

        private static Filler<Provider> CreateActiveProviderFiller(string providerName, DateTimeOffset dateTimeOffset)
        {
