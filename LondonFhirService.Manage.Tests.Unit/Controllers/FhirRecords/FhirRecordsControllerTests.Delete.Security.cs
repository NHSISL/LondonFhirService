...
namespace LondonFhirService.Manage.Tests.Unit.Controllers.FhirRecords
{
    public partial class FhirRecordsControllerTests
    {
        ...
        public void DeleteShouldHaveRoleAttributeWithRoles()
        {
            ...
            var methodInfo = controllerType.GetMethod("DeleteFhirRecordByIdAsync");
            ...
            List<string> expectedAttributeValues = (ManageRoles.AdministratorsAndUsers + ",FhirRecords.Delete")
                .Split(',')
