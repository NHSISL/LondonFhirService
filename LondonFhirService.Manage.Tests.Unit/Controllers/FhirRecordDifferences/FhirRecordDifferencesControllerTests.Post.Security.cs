...
namespace LondonFhirService.Manage.Tests.Unit.Controllers.FhirRecordDifferences
{
    public partial class FhirRecordDifferencesControllerTests
    {
        ...
        public void PostShouldHaveRoleAttributeWithRoles()
        {
            ...
            var methodInfo = controllerType.GetMethod("PostFhirRecordDifferenceAsync");
            ...
            List<string> expectedAttributeValues = (ManageRoles.AdministratorsAndUsers + ",FhirRecordDifferences.Create")
                .Split(',')
