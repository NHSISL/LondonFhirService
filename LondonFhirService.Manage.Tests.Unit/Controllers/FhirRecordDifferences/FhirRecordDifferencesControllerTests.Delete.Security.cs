...
namespace LondonFhirService.Manage.Tests.Unit.Controllers.FhirRecordDifferences
{
    public partial class FhirRecordDifferencesControllerTests
    {
        ...
        public void DeleteShouldHaveRoleAttributeWithRoles()
        {
            ...
            var methodInfo = controllerType.GetMethod("DeleteFhirRecordDifferenceByIdAsync");
            ...
            List<string> expectedAttributeValues = (ManageRoles.AdministratorsAndUsers + ",FhirRecordDifferences.Delete")
                .Split(',')
