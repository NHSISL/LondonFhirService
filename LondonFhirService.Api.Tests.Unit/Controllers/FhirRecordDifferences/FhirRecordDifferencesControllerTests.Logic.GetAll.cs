...
namespace LondonFhirService.Api.Tests.Unit.Controllers.FhirRecordDifferences
{
    public partial class FhirRecordDifferencesControllerTests
    {
        ...
        {
            // given
            IQueryable<FhirRecordDifference> randomFhirRecordDifferences =
                CreateRandomFhirRecordDifferences();

            IQueryable<FhirRecordDifference> storageFhirRecordDifferences =
                randomFhirRecordDifferences.DeepClone();

            IQueryable<FhirRecordDifference> expectedFhirRecordDifferences =
                storageFhirRecordDifferences.DeepClone();

            var expectedObjectResult =
                new OkObjectResult(expectedFhirRecordDifferences);
            ...
            ActionResult<IQueryable<FhirRecordDifference>> actualActionResult =
                await fhirRecordDifferencesController.Get();
