...
namespace LondonFhirService.Api.Tests.Unit.Controllers.FhirRecordDifferences
{
    public partial class FhirRecordDifferencesControllerTests
    {
        ...
        [Fact]
        public async Task ShouldReturnNotFoundOnDeleteIfFhirRecordDifferenceDoesNotExistAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
        ...
        [Fact]
        public async Task ShouldReturnLockedOnDeleteIfFhirRecordDifferenceIsLockedAsync()
        {
            // given
            Guid someId = Guid.NewGuid();
            ...
            var expectedActionResult =
                new ActionResult<FhirRecordDifference>(expectedLockedObjectResult);
