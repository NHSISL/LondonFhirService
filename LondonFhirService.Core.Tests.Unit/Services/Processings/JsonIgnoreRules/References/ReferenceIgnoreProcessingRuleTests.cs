...
namespace LondonFhirService.Core.Tests.Unit.Services.Processings.JsonIgnoreRules.References
{
    public partial class ReferenceIgnoreProcessingRuleTests
    {
        ...
        private readonly ReferenceIgnoreProcessingRule referenceIgnoreProcessingRule;

        public ReferenceIgnoreProcessingRuleTests()
        {
            this.jsonElementServiceMock = new Mock<IJsonElementService>();
            this.loggingBrokerMock = new Mock<ILoggingBroker>();

            this.referenceIgnoreProcessingRule =
                new ReferenceIgnoreProcessingRule(
