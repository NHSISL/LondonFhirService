...
namespace LondonFhirService.Core.Tests.Unit.Services.Processings.JsonIgnoreRules.Metas
{
    public partial class MetaIgnoreProcessingRuleTests
    {
        ...
        private readonly MetaIgnoreProcessingRule metaIgnoreProcessingRule;

        public MetaIgnoreProcessingRuleTests()
        {
            this.jsonElementServiceMock = new Mock<IJsonElementService>();
            this.loggingBrokerMock = new Mock<ILoggingBroker>();

            this.metaIgnoreProcessingRule =
                new MetaIgnoreProcessingRule(
