    ...
    public partial class ProviderServiceTests
    {
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfProviderIsNullAndLogItAsync()
        {
            ...
            ValueTask<Provider> modifyProviderTask =
                this.providerService.ModifyProviderAsync(nullProvider, TestContext.Current.CancellationToken);
            ...
            this.storageBrokerMock.Verify(broker =>
                broker.UpdateProviderAsync(It.IsAny<Provider>(), It.IsAny<CancellationToken>()),
                    Times.Never);
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfProviderIsInvalidAndLogItAsync(string invalidText)
        {
            ...
            // when
            ValueTask<Provider> modifyProviderTask =
                this.providerService.ModifyProviderAsync(invalidProvider, TestContext.Current.CancellationToken);
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfProviderHasInvalidLengthProperty()
        {
            ...
            this.storageBrokerMock.Verify(broker =>
                broker.InsertProviderAsync(It.IsAny<Provider>(), It.IsAny<CancellationToken>()),
                    Times.Never);
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfUpdatedDateIsSameAsCreatedDateAndLogItAsync()
        {
            ...
            // when
            ValueTask<Provider> modifyProviderTask = this.providerService.ModifyProviderAsync(
                invalidProvider, TestContext.Current.CancellationToken);
            ...
            this.storageBrokerMock.Verify(broker =>
                broker.SelectProviderByIdAsync(invalidProvider.Id, It.IsAny<CancellationToken>()),
                    Times.Never);
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfUpdatedDateIsNotRecentAndLogItAsync(int minutes)
        {
            ...
            // when
            ValueTask<Provider> modifyProviderTask =
                this.providerService.ModifyProviderAsync(randomProvider, TestContext.Current.CancellationToken);
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfProviderDoesNotExistAndLogItAsync()
        {
            ...
            this.storageBrokerMock.Setup(broker =>
                broker.SelectProviderByIdAsync(nonExistProvider.Id, It.IsAny<CancellationToken>()))
                    .ReturnsAsync(nullProvider);
            ...
            // when
            ValueTask<Provider> modifyProviderTask =
                this.providerService.ModifyProviderAsync(nonExistProvider, TestContext.Current.CancellationToken);
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfStorageCreatedDateNotSameAsCreatedDateAndLogItAsync()
        {
            ...
            this.securityAuditBrokerMock.Setup(broker =>
                broker.EnsureAddAuditValuesRemainsUnchangedOnModifyAsync(invalidProvider, storageProvider))
                    .ReturnsAsync(invalidProvider);
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfCreatedUserDoesNotMatchStorageAndLogItAsync()
        {
            ...
            Provider randomProvider =
                CreateRandomModifyProvider(dateTimeOffset: randomDateTimeOffset, userId: randomUserId);

            Provider invalidProvider = randomProvider.DeepClone();
            Provider storageProvider = invalidProvider.DeepClone();
            invalidProvider.CreatedBy = Guid.NewGuid().ToString();
            storageProvider.UpdatedDate = storageProvider.CreatedDate;
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfStorageUpdatedDateSameAsUpdatedDateAndLogItAsync()
        {
            ...
            invalidProviderServiceException.AddData(
                key: nameof(Provider.UpdatedDate),
                values: $"Date is the same as {nameof(Provider.UpdatedDate)}");
