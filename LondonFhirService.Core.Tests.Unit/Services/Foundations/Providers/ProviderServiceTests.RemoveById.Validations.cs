    ...
    public partial class ProviderServiceTests
    {
        ...
        public async Task ShouldThrowValidationExceptionOnRemoveIfIdIsInvalidAndLogItAsync()
        {
            ...
            ValueTask<Provider> removeProviderByIdTask =
                this.providerService.RemoveProviderByIdAsync(invalidProviderId, TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task ShouldThrowNotFoundExceptionOnRemoveByIdIfProviderIsNotFoundAndLogItAsync()
        {
            //given
