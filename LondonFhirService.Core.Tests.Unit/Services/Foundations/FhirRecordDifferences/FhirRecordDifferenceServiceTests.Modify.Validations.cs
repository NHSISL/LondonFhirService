    ...
    public partial class FhirRecordDifferenceServiceTests
    {
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfFhirRecordDifferenceIsNullAndLogItAsync()
        {
            ...
            this.storageBrokerMock.Verify(broker =>
                broker.UpdateFhirRecordDifferenceAsync(It.IsAny<FhirRecordDifference>(), It.IsAny<CancellationToken>()),
                    Times.Never);
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfFhirRecordDifferenceHasInvalidLengthProperty()
        {
            ...
            invalidFhirRecordDifferenceException.AddData(
                key: nameof(FhirRecordDifference.CorrelationId),
                values: $"Text exceeds max length of {invalidFhirRecordDifference.CorrelationId.Length - 1} characters");

            invalidFhirRecordDifferenceException.AddData(
                key: nameof(FhirRecordDifference.CreatedBy),
                values: $"Text exceeds max length of {invalidFhirRecordDifference.CreatedBy.Length - 1} characters");

            invalidFhirRecordDifferenceException.AddData(
                key: nameof(FhirRecordDifference.UpdatedBy),
                values: $"Text exceeds max length of {invalidFhirRecordDifference.UpdatedBy.Length - 1} characters");
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfUpdatedDateIsSameAsCreatedDateAndLogItAsync()
        {
            ...
            this.storageBrokerMock.Verify(broker =>
                broker.SelectFhirRecordDifferenceByIdAsync(
                    invalidFhirRecordDifference.Id, It.IsAny<CancellationToken>()),
                    Times.Never);
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfUpdatedDateIsNotRecentAndLogItAsync(int minutes)
        {
            ...
            ValueTask<FhirRecordDifference> modifyFhirRecordDifferenceTask =
                this.fhirRecordDifferenceService.ModifyFhirRecordDifferenceAsync(
                    randomFhirRecordDifference, TestContext.Current.CancellationToken);
        ...
        public async Task ShouldThrowValidationExceptionOnModifyIfFhirRecordDifferenceDoesNotExistAndLogItAsync()
        {
            ...
            this.storageBrokerMock.Setup(broker =>
                broker.SelectFhirRecordDifferenceByIdAsync(
                    nonExistFhirRecordDifference.Id, It.IsAny<CancellationToken>()))
                    .ReturnsAsync(nullFhirRecordDifference);
            ...
            ValueTask<FhirRecordDifference> modifyFhirRecordDifferenceTask =
                this.fhirRecordDifferenceService.ModifyFhirRecordDifferenceAsync(
                    nonExistFhirRecordDifference, TestContext.Current.CancellationToken);
