...
namespace LondonFhirService.Core.Tests.Unit.Services.Foundations.ResourceMatchers.Encounters
{
    ...
    {
        [Fact]
        public async Task ShouldMatchEncountersWhenBothSourcesHaveResourcesWithSameKeyAsync()
        {
            // given
            string inputDdsIdentifierValue = "ENC-1";

            JsonElement source1Resource = CreateEncounterResource(
                ddsIdentifierValue: inputDdsIdentifierValue,
                id: "encounter-1");

            JsonElement source2Resource = CreateEncounterResource(
                ddsIdentifierValue: inputDdsIdentifierValue,
                id: "encounter-2");
        ...
        [Fact]
        public async Task ShouldAddToUnmatchedFromSource1WhenOnlySource1HasEncounterAsync()
        {
            // given
            string inputDdsIdentifierValue = "ENC-1";
        ...
        [Fact]
        public async Task ShouldAddToUnmatchedFromSource2WhenOnlySource2HasEncounterAsync()
        {
            // given
            string inputDdsIdentifierValue = "ENC-1";
        ...
        [Fact]
        public async Task ShouldMatchComprehensiveEncountersWithMultipleIdentifierSystemsAsync()
        {
            // given
            string inputDdsIdentifierValue = "ENC-comprehensive-1";

            JsonElement source1Resource = CreateComprehensiveEncounterResource(
                ddsIdentifierValue: inputDdsIdentifierValue,
                id: "encounter-comprehensive-1");

            JsonElement source2Resource = CreateComprehensiveEncounterResource(
                ddsIdentifierValue: inputDdsIdentifierValue,
                id: "encounter-comprehensive-2");
        ...
        [Fact]
        public async Task ShouldExcludeEncountersWithNoDdsIdentifierFromMatchResultsAsync()
        {
            // given
            JsonElement source1Resource = CreateNonDdsEncounterResource(id: "encounter-1");
            JsonElement source2Resource = CreateNonDdsEncounterResource(id: "encounter-2");
            var source1Resources = new List<JsonElement> { source1Resource };
            var source2Resources = new List<JsonElement> { source2Resource };
            Dictionary<string, JsonElement> source1ResourceIndex = CreateResourceIndex();
            Dictionary<string, JsonElement> source2ResourceIndex = CreateResourceIndex();
