...
namespace LondonFhirService.Core.Tests.Unit.Services.Foundations.ResourceMatchers.Appointments
{
    public partial class AppointmentMatcherServiceTests
    {
        ...
        [Fact]
        public async Task ShouldReturnNullMatchKeyForAppointmentWithNonDdsIdentifierAsync()
        {
            // given
            JsonElement appointmentResource = CreateAppointmentWithNonDdsIdentifier();
            Dictionary<string, JsonElement> resourceIndex = CreateResourceIndex();
