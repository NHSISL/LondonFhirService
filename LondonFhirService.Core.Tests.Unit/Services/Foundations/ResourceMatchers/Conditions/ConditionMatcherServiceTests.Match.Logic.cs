...
using LondonFhirService.Core.Models.Foundations.Conditions;
...
{
    [Fact]
    public void ShouldMatchConditionResources()
    {
        // given
        ...
        // when
        ResourceMatch actualResourceMatch = this.conditionMatcherService.Match(
            source1Resources,
            source2Resources,
