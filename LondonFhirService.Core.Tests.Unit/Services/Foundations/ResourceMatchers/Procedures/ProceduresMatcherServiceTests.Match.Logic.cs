    ...
    public partial class ProcedureMatcherServiceTests
    {
        ...
        public async Task ShouldAddToUnmatchedFromSource1WhenOnlySource1HasProcedureAsync()
        {
            ...
            expectedResourceMatch.Unmatched.Add(
                new UnmatchedResource(source1Resource, "Procedure", ExpectedMatchKey(inputDdsIdentifierValue), true));
        ...
        public async Task ShouldAddToUnmatchedFromSource2WhenOnlySource2HasProcedureAsync()
        {
            ...
            expectedResourceMatch.Unmatched.Add(
                new UnmatchedResource(source2Resource, "Procedure", ExpectedMatchKey(inputDdsIdentifierValue), false));
        ...
        [Fact]
        public async Task ShouldMatchComprehensiveProceduresWithMultipleIdentifierSystemsAsync()
        {
            // given
            string inputDdsIdentifierValue = "PROC-comprehensive-1";

            JsonElement source1Resource = CreateComprehensiveProcedureResource(
                ddsIdentifierValue: inputDdsIdentifierValue,
                id: "procedure-comprehensive-1");

            JsonElement source2Resource = CreateComprehensiveProcedureResource(
                ddsIdentifierValue: inputDdsIdentifierValue,
                id: "procedure-comprehensive-2");
        ...
        [Fact]
        public async Task ShouldExcludeProceduresWithNoDdsIdentifierFromMatchResultsAsync()
        {
            // given
            JsonElement source1Resource = CreateNonDdsProcedureResource(id: "procedure-1");
            JsonElement source2Resource = CreateNonDdsProcedureResource(id: "procedure-2");
            var source1Resources = new List<JsonElement> { source1Resource };
            var source2Resources = new List<JsonElement> { source2Resource };
            Dictionary<string, JsonElement> source1ResourceIndex = CreateResourceIndex();
            Dictionary<string, JsonElement> source2ResourceIndex = CreateResourceIndex();
