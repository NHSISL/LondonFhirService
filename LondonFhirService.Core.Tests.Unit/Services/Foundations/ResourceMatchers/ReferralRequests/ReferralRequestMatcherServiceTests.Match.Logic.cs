    ...
    public partial class ReferralRequestMatcherServiceTests
    {
        ...
        public async Task ShouldAddToUnmatchedFromSource1WhenOnlySource1HasReferralRequestAsync()
        {
            ...
            expectedResourceMatch.Unmatched.Add(
                new UnmatchedResource(source1Resource, "ReferralRequest", ExpectedMatchKey(inputDdsIdentifierValue), true));
        ...
        [Fact]
        public async Task ShouldAddToUnmatchedFromSource2WhenOnlySource2HasReferralRequestAsync()
        {
            // given
            string inputDdsIdentifierValue = "RR-1";
            ...
            expectedResourceMatch.Unmatched.Add(
                new UnmatchedResource(source2Resource, "ReferralRequest", ExpectedMatchKey(inputDdsIdentifierValue), false));
        ...
        [Fact]
        public async Task ShouldMatchComprehensiveReferralRequestsWithMultipleIdentifierSystemsAsync()
        {
            // given
            string inputDdsIdentifierValue = "RR-comprehensive-1";

            JsonElement source1Resource = CreateComprehensiveReferralRequestResource(
                ddsIdentifierValue: inputDdsIdentifierValue,
                id: "referral-request-comprehensive-1");

            JsonElement source2Resource = CreateComprehensiveReferralRequestResource(
                ddsIdentifierValue: inputDdsIdentifierValue,
                id: "referral-request-comprehensive-2");
        ...
        [Fact]
        public async Task ShouldExcludeReferralRequestsWithNoDdsIdentifierFromMatchResultsAsync()
        {
            // given
            JsonElement source1Resource = CreateNonDdsReferralRequestResource(id: "referral-request-1");
            JsonElement source2Resource = CreateNonDdsReferralRequestResource(id: "referral-request-2");
            var source1Resources = new List<JsonElement> { source1Resource };
            var source2Resources = new List<JsonElement> { source2Resource };
            Dictionary<string, JsonElement> source1ResourceIndex = CreateResourceIndex();
            Dictionary<string, JsonElement> source2ResourceIndex = CreateResourceIndex();
