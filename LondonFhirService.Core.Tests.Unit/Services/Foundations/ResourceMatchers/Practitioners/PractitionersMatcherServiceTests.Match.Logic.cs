...
namespace LondonFhirService.Core.Tests.Unit.Services.Foundations.ResourceMatchers.Practitioners
{
    public partial class PractitionerMatcherServiceTests
    {
        ...
        [Fact]
        public async Task ShouldMatchComprehensivePractitionersWithMultipleIdentifierSystemsAsync()
        {
            // given
            string inputSdsUserId = "999999000123";

            JsonElement source1Resource = CreateComprehensivePractitionerResource(
                sdsUserId: inputSdsUserId,
                id: "practitioner-comprehensive-1");

            JsonElement source2Resource = CreateComprehensivePractitionerResource(
                sdsUserId: inputSdsUserId,
                id: "practitioner-comprehensive-2");
